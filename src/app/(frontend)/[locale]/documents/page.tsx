        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {docs.map((doc) => (
            <Link
              ...
              className="group flex items-center justify-between p-8 bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md hover:border-[#03164f] hover:-translate-y-1 transition-all duration-200"
            >
              <div className="flex flex-col">
                <span className="text-4xl font-extrabold text-gray-800 group-hover:text-[#03164f] transition-colors">
                  {doc.year}
                </span>
              ...
              <div className="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center group-hover:bg-[#03164f]/10 transition-colors duration-300">
                <ArrowRight className="w-6 h-6 text-[#03164f] group-hover:text-white" />
              </div>
            </Link>
          ))}
        </div>
